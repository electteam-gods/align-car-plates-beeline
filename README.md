...
То есть сделать такие решения, которые позволили бы повысить точность и качество распознавания. Одним из этапов достижения поставленной цели является выравнивание перспективы вырезанных из видеопотока автомобильных номеров.
